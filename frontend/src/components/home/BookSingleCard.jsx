...
const BookSingleCard = ({ book }) => {
  ...
  return (
    <div className="border-2 border-gray-500 rounded-lg px-4 py-2 m-4 relative hover:shadow-2xl transition-shadow duration-300">
      <h2 className="absolute top-1 right-2 px-4 py-1 bg-red-300 rounded-lg text-sm font-semibold">
        {book.publishYear}
      </h2>
      ...
      <div className="flex justify-between items-center gap-x-2 mt-4 p-4">
        <BiShow
          className="text-3xl text-blue-800 hover:text-black cursor-pointer transition-colors duration-200"
